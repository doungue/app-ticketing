<?php 
    ...
    require('../actions/questions/showTableClientAction.php'); 
   ...
   <main>
          ...
          <main id="main" class="main">
            ...
            <div class="pagetitle">
              ...
              <nav>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="../client/client.php">Home</a></li>
        ...
        <div class="col-lg-12 d-flex justify-content-between align-items-center">
            ...
            <div>
               <a class="btn btn-success" href="../ticket/ticketopen.php" role="button">Tickets Ouverts</a>
            </div> 
            <div>
               <a class="btn btn-secondary" href="ticketclose.php" role="button">Tickets Fermés</a>
            </div>
            <div>
              <h4></h4>
            </div>
        ...
        <div class="col-lg-7 d-flex justify-content-between align-items-center">
             <div>
              <h4></h4>
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                 <i class="bi bi-plus-circle"></i> Creer un Ticket
                </button>
                </div>
        </div>
<br>
...
<!-- Button trigger modal -->
    ...
    <script src= "../script/liste_tickets_client.js"></script>
