...
<body>
  ...
  <!-- ======= Header ======= -->
  <?php
         include '../client/include/navbar.php'
         ?>
 <!-- End Header -->
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Tickets totals </h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->prepare("SELECT  COUNT(*)  as NbNews FROM tickets WHERE id_auteur = ? " );
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->prepare("SELECT  COUNT(*)  as NbNews FROM tickets WHERE id_auteur = ? AND statut = 'En cours' " );
                     $req->execute(array($_SESSION['id']));
                     $donnees = $req->fetch();
                     $req->closeCursor();
                     if( $req->rowCount() > 0){
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->prepare("SELECT  COUNT(*)  as NbNews FROM tickets WHERE id_auteur = ? AND statut = 'close' " );
                     $req->execute(array($_SESSION['id']));
                     $donnees = $req->fetch();
                     $req->closeCursor();
                     if( $req->rowCount() > 0){
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->prepare("SELECT  COUNT(*)  as NbNews FROM tickets WHERE id_auteur = ? AND statut = 'Terminé' " );
                     $req->execute(array($_SESSION['id']));
                     $donnees = $req->fetch();
                     $req->closeCursor();
                     if( $req->rowCount() > 0){
  ...
  <!-- ======= Footer ======= -->
  <?php 
    include '../client/include/footer.php';
  ?>
