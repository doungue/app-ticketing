<?php 
    ...
    require('../actions/questions/showAllTicketFermeUserAction.php');
...
<body>
 ...
 <!-- End Header -->
  ...
  <li>
    <div>
    <button type='button'  class='dropdown-item  btn btn-warning'  ><a href='validation.php?id= <?= $question['id']; ?>'>Validation</a></button>
    </div>
    </li>
    <li>
    <div>
