        ...
        ?>
          <div class="card">
            <div class="card-body">
              ...
              <a href="../actions/questions/openTicketAction.php?id=<?= $question_id; ?>"> Close</a> 
            </button></span>
            <?php
         }elseif($question_statut == "close"){?>
...
<?php }else{?>
  ...
  <?php
        ...
        ?>
            ...
            <hr>
            <small><?= '<a href="../admin/users-profile.php?id='.$question_id_author.'">'.$question_pseudo_author . '</a> ' . $question_publication_date; ?></small>
        </section>
        <br>
