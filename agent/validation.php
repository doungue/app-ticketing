<?php 
    ...
    require('../actions/questions/valideTicketAction.php');
...
<body>
 ...
 <!-- End Header -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Valider le ticket</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../agent/agent.php">Home</a></li>
          <li class="breadcrumb-item">Valider le ticket</li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Valider le ticket  </h5> 
 ...
 if(isset($question_assigner)){ 
      ...
      <?php 
        ...
        ?>
          <div class="mb-3">
          <label for="type_demande" class="col-sm-5 col-form-label">Valider:</label>
        <select class="form-select" aria-label="Default select example" id="statut" name="statut" required>
