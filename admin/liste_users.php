            ...
            <div class="pagetitle">
              ...
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Listes des Users</li>
            ...
            <section class="section">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Listes des Users </h5> 
        ...
        <div class="col-lg-12 d-flex justify-content-between align-items-center">
            ...
            <!-- Button trigger modal -->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                 <i class="bi bi-plus-circle"></i> Nouveau User
                </button>
            </div>
        </div>
<br>
...
<!-- Modal -->
      ...
      <?php
         include '../modal/new_user_Modal.php';
        ?>
...
<!-- Button trigger modal -->
    ...
    <script src= "../script/listes_users.js"></script>
...
<script src = "../script/newusers.js"></script>
<?php 
