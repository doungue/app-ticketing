              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->query("SELECT  COUNT(*)  as NbNews FROM tickets" );
                     $donnees = $req->fetch();
                     $req->closeCursor();
                     if( $req->rowCount() > 0){
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->query("SELECT  COUNT(*)  as NbNews FROM tickets WHERE statut ='En cours' " );
                     $donnees = $req->fetch();
                     $req->closeCursor();
                     if( $req->rowCount() > 0){
                      echo '<h6>'.$donnees['NbNews'].'</h6>';
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->query("SELECT  COUNT(*)  as NbNews FROM tickets WHERE statut ='close' " );
                     $donnees = $req->fetch();
                     $req->closeCursor();
                     if( $req->rowCount() > 0){
                      echo '<h6>'.$donnees['NbNews'].'</h6>';
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <?php
                     $req = $bdd->query("SELECT  COUNT(*)  as NbNews FROM tickets WHERE statut ='Terminé' " );
                     $donnees = $req->fetch();
                     $req->closeCursor();
                     if( $req->rowCount() > 0){
                      echo '<h6>'.$donnees['NbNews'].'</h6>';
